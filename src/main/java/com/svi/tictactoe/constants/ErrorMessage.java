...
public enum ErrorMessage {
    ...
    CURRENT_GAME_NOT_COMPLETED("Cannot start a new round as the active gameId '%s' still not completed or in progress"),
    ...
    MOVING_PLAYER_SYMBOL_NOT_FOUND("Moving player symbol '%s' was not found."),
